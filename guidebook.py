...
''', [
    ...
    ('Мать-и-мачехин сироп', 'Средство от кашля', 3, 'Отхаркивающее средство', 'Пероральное применение', 3.0, '2023-03-01', '2024-03-01', 12.25),
    ...
    ('Мать-и-мачехин бальзам', 'Средство от кашля', 3, 'Для местного применения', 'Наружное применение', 2.2, '2023-08-01', '2024-08-01', 14.75),
